##**(Kaggle)Investigating Airbnb activity in Berlin,Germany**********************##
##**Creators of this project are mentioned below*********************************##
##**Vivek Advani, Samrita Ghosh, Ruying Situ, Aniruddhsinh Vashi, Nishit Patel**##
##**4sections:DataCleaning, FeatureEngineering, DataVisualization, DataModelling##
